/* @ts-self-types="./gamechat_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function make_chat_message(room_id, sender_id, content) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.make_chat_message(ptr0, len0, ptr1, len1, ptr2, len2);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
 ...
 * @returns {string}
 */
export function make_join(room_id, peer_id) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(room_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.make_join(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gamechat_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
